...
namespace Kiwi
{
    public class BezierCurve3D : MonoBehaviour
    {
        ...
        Color startPointColor = Color.red;

        [SerializeField]
        [Tooltip("The color used to render the end point of the curve")]
        Color endPointColor = Color.blue;
        ...
        [SerializeField]
        [HideInInspector]
        List<BezierPoint3D> keyPoints = new();
        ...
        protected virtual void OnDrawGizmos()
        {
            if (KeyPointsCount > 1)
            {
                ...
                Vector3 point = GetPoint(normalizedTime);
